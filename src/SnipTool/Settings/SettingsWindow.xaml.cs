...
public partial class SettingsWindow : Window
{
    ...
    private void DisableSnip_Click(object sender, RoutedEventArgs e)
    {
        ...
        MessageBox.Show(ok
            ? "Windows PrtSc→Snipping mapping disabled. PrtSc can now trigger Snip Tool."
            : "Could not change the setting.", "Snip Tool");
    }
    ...
    private void Save_Click(object sender, RoutedEventArgs e)
    {
        ...
        var reg = new StartupRegistration("SnipTool", Environment.ProcessPath ?? "");
